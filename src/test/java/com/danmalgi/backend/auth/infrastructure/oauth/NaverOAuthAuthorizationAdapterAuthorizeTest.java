...
import com.danmalgi.backend.auth.infrastructure.oauth.impl.NaverOAuthAuthorizationAdapter;
...
class NaverOAuthAuthorizationAdapterAuthorizeTest {

    private NaverOAuthAuthorizationAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new NaverOAuthAuthorizationAdapter();
    }
    ...
    @Test
    void supportedOauthType은_NAVER다() {
        assertThat(adapter.supportedOauthType()).isEqualTo(OauthType.NAVER);
    }
}
